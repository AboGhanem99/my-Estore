...
function Footer() {
  ...
  <Box marginTop="70px" padding="40px 0" backgroundColor={neutral.light} WebkitUserSelect = "all" >
      <Box
        width="80%"
        margin="auto"
        display="flex"
      ...
      >
        ...
        <Box width="clamp(20%, 25%, 30%)">
          ...
          <Typography mb="30px" sx={{ wordWrap: "break-word" }}>Email: mredwardroh@gmail.com</Typography>
